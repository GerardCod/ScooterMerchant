...
class PermissionGalleryPage extends StatefulWidget {
  PermissionGalleryPage({Key key}) : super(key: key);

  @override
  _PermissionGalleryPageState createState() => _PermissionGalleryPageState();
}
    ...
    return Padding(
      padding: EdgeInsets.symmetric(horizontal:20),
        ...
        children: <Widget>[
          ...
          Text(
            "${_prefs.merchant.merchantName}, \n es necesario que nos concedas permisos para abrir tu galeria",
            style: TextStyle(
